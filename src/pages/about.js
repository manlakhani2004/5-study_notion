                                ...
                                <div class="flex flex-wrap items-center">
                                    <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                                        <div class="p-6 bg-white dark:bg-gray-900">
                                            ...
                                            <p class="mt-4 mb-2 text-3xl font-bold text-gray-700 dark:text-gray-400">1,000
                                            </p>
                                            <h2 class="text-sm text-gray-700 dark:text-gray-400">SHEDULES</h2>
                                        </div>
                                    </div>
                                    <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                                        <div class="p-6 bg-white dark:bg-gray-900">
                                            ...
                                            <p class="mt-4 mb-2 text-3xl font-bold text-gray-700 dark:text-gray-400">320
                                            </p>
                                            <h2 class="text-sm text-gray-700 dark:text-gray-400">TRUSTED TUTORS</h2>
                                        </div>
                                    </div>
                                    <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                                        <div class="p-6 bg-white dark:bg-gray-900">
                                            ...
                                            <p class="mt-4 mb-2 text-3xl font-bold text-gray-700 dark:text-gray-400">3,000
                                            </p>
                                            <h2 class="text-sm text-gray-700 dark:text-gray-400">SUCCESS STORIES</h2>
                                        </div>
                                    </div>
                                    <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                                        <div class="p-6 bg-white dark:bg-gray-900">
                                            ...
                                            <p class="mt-4 mb-2 text-3xl font-bold text-gray-700 dark:text-gray-400">653
                                            </p>
                                            <h2 class="text-sm text-gray-700 dark:text-gray-400">COURSES</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
